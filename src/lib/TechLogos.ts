...
export const techLogos: LogoItem[] = [
    ...
    { src: gitLogo, alt: 'Git', title: 'Git', href: 'https://git-scm.com' },
    {
        src: dockerLogo,
        alt: 'Docker',
        title: 'Docker',
    ...
    },
    {
        ...
        alt: 'C#',
        title: 'C#',
        href: 'https://learn.microsoft.com/es-es/dotnet/csharp/'
    },
    {
        src: aspnetLogo,
        alt: 'ASP.NET',
    ...
    { src: zodLogo, alt: 'Zod', title: 'Zod', href: 'https://zod.dev' },
    {
        src: postmanLogo,
        alt: 'Postman',
        title: 'Postman',
